...
export interface CSVRow {
  // ID field - support multiple column names used by different systems
  ID?: string;
  "#"?: string;
  "Work Package ID"?: string;
  "Ticket ID"?: string;
  id?: string;
  Assignee: string;
  ...
  Subject: string;
  Parent?: string;  // Parent feature ID - points to the parent ticket's ID
